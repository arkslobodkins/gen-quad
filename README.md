...
Use instructions:  
Requires at least C99 or C++98 or more recent, as well as Math Kernel Library(MKL). 
In addition, PLASMA library is used in OpenMP mode for sufficiently large problems.
